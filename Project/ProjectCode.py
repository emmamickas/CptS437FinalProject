...
def PredictBasedOnExtroversion(file_out, alltrainingdatasetquestions, alltrainingdatasettotals, alltrainingdatasetpreferences, alltestingdatasetquestions, alltestingdatasettotals, alltestingdatasetpreferences):
    ...
    reducedextroversionquestions = alltrainingdatasetquestions[:,reducedextroversionquestionindeces]
...
def ClusteringExtroversionNeuroticism(datasettotals):
    ...
    extroversion = datasettotals[:,0]
    neuroticism = datasettotals[:,1]
...
def main():
    ...
    prunedindexes, weight, averageweight = PerceptronForPruningMultiplePredictions(trainingdataset, datasetpreferences_training, (10, 20), [0, 2, 3, 4], 5, 1, 3)
    print("Weight:", weight)
