...
def Shrinker():
    ...
    for line in file_in:
        ...
        if 'NULL' not in line[:100] and zero == 0:
            #if CalculateOpennessString(line[:50]) < 0:
            #    print("Open")
            #elif CalculateOpennessString(line[:50]) > 0:
            #    print("Not Open")
            file_out.writerow(line[:100])
            linecount += 1
        i += 1
...
def CalculateOpennessString(row):
    total = 0
    total += int(row[40])
    total -= int(row[41])
    total += int(row[42])
...
def PredictExtroversion(file_out, allsampledatasettotals, allsampledatasetpreferences, alltestdatasettotals, alltestdatasetpreferences):
    ...
    clf_lars = linear_model.LassoLars(alpha=1, max_iter=20)
    ...
    clf_lars2 = linear_model.LassoLars(alpha=1, max_iter=20)
    ...
    clf_logistic = linear_model.LogisticRegression(penalty='l1', solver='liblinear', tol=1e-6, max_iter=20, warm_start=True, intercept_scaling=10000.)
    ...
    clf_decisiontree = DecisionTreeRegressor(max_depth=20)
    ...
    clf_decisiontree2 = DecisionTreeRegressor(max_depth=20)
...
def PredictBasedOnExtroversion(file_out, allsampledataset, allsampledatasettotals, allsampledatasetpreferences, alltestdataset, alltestdatasettotals, alltestdatasetpreferences):
    ...
    neuroticismclf_lars = linear_model.LassoLars(alpha=1, max_iter=20)
    ...
    neuroticismclf_decisiontree = DecisionTreeRegressor(max_depth=20)
    ...
    agreeablenessclf_lars = linear_model.LassoLars(alpha=1, max_iter=20)
    ...
    agreeablenessclf_decisiontree = DecisionTreeRegressor(max_depth=20)
    ...
    conscientiousnessclf_lars = linear_model.LassoLars(alpha=1, max_iter=20)
    ...
    conscientiousnessclf_decisiontree = DecisionTreeRegressor(max_depth=20)
    ...
    opennessclf_lars = linear_model.LassoLars(alpha=1, max_iter=20)
    ...
    opennessclf_decisiontree = DecisionTreeRegressor(max_depth=20)
...
def PredictBasedOnNeuroticism(file_out, allsampledataset, allsampledatasettotals, allsampledatasetpreferences, alltestdataset, alltestdatasettotals, alltestdatasetpreferences):
    ...
    extroversionclf_lars = linear_model.LassoLars(alpha=1, max_iter=20)
    ...
    opennessclf_logistic = linear_model.LogisticRegression(penalty='l1', solver='liblinear', tol=1e-6, max_iter=20, warm_start=True, intercept_scaling=10000.)
